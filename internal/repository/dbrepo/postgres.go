...
// SearchAvailabilityByDatesByRoomID returns true if availability exists for roomID, and false if no
...
func (m *postgresDBRepo) GetUserByID(id int) (models.User, error) {
	...
	query := `select id, first_name, last_name, email, password, access_level, created_ate, updated_at
...
func (m *postgresDBRepo) UpdateUser(u models.User) error {
	...
	query := `update users first_name = $1, last_name = $2, email = $3, access_level = $4, updated_at = $5`
...
// UpdateReservation updates the user in the database
...
// InsertBlockFormRoom inserts a room restriction
func (m *postgresDBRepo) InsertBlockFormRoom(id int, startDate time.Time) error {
	ctx, cancel := context.WithTimeout(context.Background(), 3*time.Second)
	defer cancel()
...
// DeleteBlockByID inserts a room restriction
