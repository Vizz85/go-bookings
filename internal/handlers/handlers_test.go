...
var theTests = []struct {
	...
	//	{key: "start", value: "2021-02-02"},
	//	{key: "end", value: "2021-02-06"},
	//}, http.StatusOK},
...
func TestRepository_PostReservation(t *testing.T) {
	...
	reqBody = fmt.Sprintf("%s&%s", reqBody, "phone=1234")
	...
	reqBody = fmt.Sprintf("%s&%s", reqBody, "last_name=Smith")
	reqBody = fmt.Sprintf("%s&%s", reqBody, "email=john@invalid")
	reqBody = fmt.Sprintf("%s&%s", reqBody, "phone=1234")
	...
	// cause the error in test-repo.go
